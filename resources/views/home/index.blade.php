                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 col-12 col-sm-6">
                                <div class="slider-single-img slider-animated-1">
                                    ...
                                    <img class="animated" src="{{ generateBannerImageLink($slider->image) }}"
                                        alt="{{ $slider->image }}" />
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="single-banner mb-30 scroll-zoom">
                            <a href="#"><img class="animated"
                                    src="{{ generateBannerImageLink($indexBottomBanner->image) }}"
                                    alt="{{ $indexBottomBanner->image }}" /></a>
                            <div
                                ...
                                <a href="{{ $indexBottomBanner->button_link }}">{{ $indexBottomBanner->button_text }}</a>
                            </div>
                        </div>
                    </div>
                @endforeach
                                                ...
                                                <li>
                                                    @auth
                                                        @if ($product->checkUserWishlist(auth()->id()))
                                                            <a href="{{ route('home.wishlist.remove', $product) }}"><i
                                                        ...
                                                        @else
                                                            <a href="{{ route('home.wishlist.add', $product) }}"><i
                    ...
                    <div class="col-lg-6 col-md-6 text-right">
                        <div class="single-banner mb-30 scroll-zoom">
                            <a href="{{ $banner->button_link }}"><img
                                    src="{{ generateBannerImageLink($banner->image) }}"
                                    alt="{{ $banner->image }}" /></a>
                                ...
                                <div class="tab-content quickview-big-img">
                                    ...
                                    @foreach ($product->images as $image)
                                        <div id="pro-{{ $image->id }}" class="tab-pane fade">
                                            <img src="{{ generateProductImageLink($image->image) }}" alt="" />
                                        </div>
                                    @endforeach
                                    ...
                                    <div class="quickview-slide-active owl-carousel nav nav-style-2" role="tablist">
                                        ...
                                        @foreach ($product->images as $image)
                                            <a data-toggle="tab" href="#pro-{{ $image->id }}"><img
                                                    src="{{ generateProductImageLink($image->image) }}"
                                                    alt="" /></a>
                                        @endforeach
